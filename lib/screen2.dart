...
class _Screen2State extends State<Screen2> {
  List<bool> _selected = [false, true]; // Student is selected here
  ...
  void _handleStudentLogin() async {
    ...
    try {
      ...
      if (authViewModel.isAuthenticated) {
        // For students, navigate to HomePage regardless of role
        // You might want to add role checking here too if needed
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: ToggleButtons(
                      ...
                      fillColor: const Color(0xFF191C32),
                      ...
                      onPressed: authViewModel.isLoading
                          ...
                          : (int index) {
                              ...
                              if (index == 0) {
                                ...
                                // Student selected → stay here
                                // Do nothing (already on Screen2)
                              }
                            },
                      children: const [
                        Padding(
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    onPressed:
                        authViewModel.isLoading ? null : _handleStudentLogin,
                    style: ButtonStyle(
                      backgroundColor: WidgetStateProperty.resolveWith<Color>(
                        (Set<WidgetState> states) {
                          if (states.contains(WidgetState.disabled)) {
                            return const Color(0xFF191C32).withOpacity(0.6);
                          }
                          return const Color(0xFF191C32);
                        },
                      ),
                      fixedSize:
